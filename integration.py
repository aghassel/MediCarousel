...
ser = serial.Serial('COM9', 9600)  # Adjust baud rate as needed
...
while True:
    ...
    record_audio(duration=3, filename="output.wav")
...
# ///////////////////////////////// Serial Communication with Arduino /////////////////////////////
    ...
    newestTranscription = transcription.lower().strip()


    if newestTranscription.endswith('.'):
        newestTranscription = newestTranscription[0: len(newestTranscription) - 1]

    print(newestTranscription)
    if ("scalpel" in newestTranscription) or ("scalpel." in newestTranscription):
        ser.write(b'w')
        print("white")
    elif ("scissors" in newestTranscription) or ("scissors." in newestTranscription):
        ser.write(b'b')
        print("black")
